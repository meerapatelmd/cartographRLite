...
#' @param cui umls cui as a character string of length 1
#' @param str closest matching umls str as a characters string of length 1
#' @import crayon
#' @import dplyr
#' @import readr
#' @export

save_one_cui_that_matches_concept <-
